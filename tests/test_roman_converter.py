...
class TestRomanConverter(unittest.TestCase):
    ...
    def test_complex_numbers(self):
        self.assertEqual(decimal_to_roman(335), 'CCCXXXV')
        self.assertEqual(decimal_to_roman(1115), 'MCXV')
        self.assertEqual(decimal_to_roman(3512), 'MMMDXII')
        self.assertEqual(decimal_to_roman(990), 'CMXC')
